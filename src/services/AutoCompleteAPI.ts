...
/* acceptable languages in placeAutocomplete method */
...
export default class AutoCompleteAPI {
    ...
    static async placeAutocomplete(text: string,  lang: languages, limit: number = 5): Promise<IPlace[] | null> {
        ...
        try {
            ...
            /* shows and returns null on error */
            console.error(e);
            return null
        }
    }
